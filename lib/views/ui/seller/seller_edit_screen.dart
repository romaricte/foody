...
import 'package:myfoody/controller/ui/seller/seller_edit_controller.dart';
...
class _SellerEditScreenState extends State<SellerEditScreen>
  ...
  late SellerEditController controller;

  @override
  void initState() {
    controller = Get.put(SellerEditController());
    super.initState();
  }
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Edit Detail', active: true),
                      ],
                    ),
                  ],
                ),
